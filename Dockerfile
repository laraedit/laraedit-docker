...
# install php
RUN apt-get install -y --force-yes php7.0-fpm php7.0-cli php7.0-dev php-pgsql php-sqlite3 php-gd \
    php-apcu php-curl php7.0-mcrypt php-imap php-mysql php-memcached php7.0-readline php-xdebug \
